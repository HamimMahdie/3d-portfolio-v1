# Hamim Mahdie Portfolio

This repository contains the source code for Hamim Mahdie's 3D portfolio, rebuilt around a more recruiter-focused narrative while keeping the immersive React, Three.js, and GSAP presentation layer.
...
```text
.
├── public/                    # Static assets (resume, images, 3D model files)
├── src/
│   ├── components/
