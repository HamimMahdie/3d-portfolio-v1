...
const toolkitFamilies = [
  ...
  },
  {
    title: "Backend",
    accent: "#8cc84b",
    summary: "Production-first tooling for services, APIs, and application logic.",
    items: ["Spring Boot", "Node.js", "Flask", "REST APIs", "Kafka"],
  },
  {
    title: "AI / ML",
    accent: "#ff8f52",
    summary: "Research and applied AI tooling for fast iteration and real product value.",
    items: ["TensorFlow", "PyTorch", "Jupyter", "LLM Workflows", "RAG Systems"],
  },
  {
    title: "Cloud",
    accent: "#5a86ff",
    summary: "Delivery and infrastructure tools that move ideas into reliable systems.",
    items: ["Docker", "Kubernetes", "Google Cloud", "CI / CD", "Observability"],
  },
  {
    title: "Frontend",
    accent: "#f7df1e",
